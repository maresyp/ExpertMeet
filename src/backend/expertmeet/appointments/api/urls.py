...
urlpatterns = [
    ...
    #
    path("appointments/get_schedule/<uuid:profile_id>", views.get_schedule, name="get_schedule"),
    path("appointments/update_schedule", views.update_schedule, name="update_schedule"),
    path("appointments/create_appointment/<uuid:profile_id>", views.create_appointment, name="create_appointment"),
]
